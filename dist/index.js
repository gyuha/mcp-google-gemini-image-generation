...
class GeminiImageServer {
    constructor() {
        ...
        this.imageGenerator = new ImageGenerator(DEFAULT_CONFIG.apiKey, DEFAULT_CONFIG.outputDir, DEFAULT_CONFIG.defaultModel);
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            if (request.params.name === "generate_image") {
                ...
                if (!params || typeof params.prompt !== 'string') {
                    throw new McpError(ErrorCode.InvalidParams, "Prompt is required to generate an image");
                }
                const imageParams = {
                ...
                if (!args || typeof args.path !== 'string') {
                    throw new McpError(ErrorCode.InvalidParams, "Output path is required");
                }
                const params = {
                    path: args.path
                };
